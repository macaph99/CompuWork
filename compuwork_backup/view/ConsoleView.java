...
public class ConsoleView {
    ...
    private int leerInt(String m) {
        System.out.print(m);
        while (!sc.hasNextInt()) { System.out.print("Ingrese entero: "); sc.next(); }
        int v = sc.nextInt(); sc.nextLine(); return v;
    }
    
    private double leerDbl(String m) {
        System.out.print(m);
        while (!sc.hasNextDouble()) { System.out.print("Ingrese número: "); sc.next(); }
        double v = sc.nextDouble(); sc.nextLine(); return v;
    }
    
    private String leerTxt(String m) { 
        System.out.print(m); 
        return sc.nextLine(); 
    }
    
    private LocalDate leerFecha(String m) {
        while (true) {
            try { return LocalDate.parse(leerTxt(m)); }
